    ...
    def __init__(self, factory_seed, coarse=False, factory_method=None, control=False, control_dict={}):
        ...
        with FixedSeed(factory_seed):
            ...
            if 'factory_method' in control_dict:
                ...
                factory_method = GlobularBaseCactusFactory if 'Globular' in f_name or 'globular' in f_name else None
                factory_method = ColumnarBaseCactusFactory if 'Columnar' in f_name or 'columnar' in f_name else None
                factory_method = PrickyPearBaseCactusFactory if 'PrickyPear' in f_name or 'prickypear' in f_name else None
